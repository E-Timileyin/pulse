...
func TestSingleDownloader_Download_Success(t *testing.T) {
	...
	tmpDir, cleanup, err := testutil.TempDir("pulse-single-test")
	if err != nil {
		t.Fatal(err)
	}
	defer cleanup()
...
func TestSingleDownloader_Download_Cancellation(t *testing.T) {
	...
	tmpDir, cleanup, _ := testutil.TempDir("pulse-cancel-single")
	defer cleanup()
...
func TestSingleDownloader_Download_ProgressTracking(t *testing.T) {
	...
	tmpDir, cleanup, _ := testutil.TempDir("pulse-progress-single")
	defer cleanup()
...
func TestSingleDownloader_Download_ServerError(t *testing.T) {
	...
	tmpDir, cleanup, _ := testutil.TempDir("pulse-error-single")
	defer cleanup()
...
func TestSingleDownloader_Download_WithLatency(t *testing.T) {
	...
	tmpDir, cleanup, _ := testutil.TempDir("pulse-latency-single")
	defer cleanup()
...
func TestSingleDownloader_Download_ContentIntegrity(t *testing.T) {
	...
	tmpDir, cleanup, _ := testutil.TempDir("pulse-content-single")
	defer cleanup()
...
func TestCopyFile(t *testing.T) {
	tmpDir, cleanup, err := testutil.TempDir("pulse-copy-test")
	if err != nil {
		t.Fatal(err)
	}
	defer cleanup()
...
func TestCopyFile_SourceNotExists(t *testing.T) {
	tmpDir, cleanup, _ := testutil.TempDir("pulse-copy-test")
	defer cleanup()
...
func TestCopyFile_ContentVerification(t *testing.T) {
	tmpDir, cleanup, _ := testutil.TempDir("pulse-copy-content")
	defer cleanup()
...
func TestSingleDownloader_StreamingServer(t *testing.T) {
	...
	tmpDir, cleanup, _ := testutil.TempDir("pulse-stream-single")
	defer cleanup()
...
func TestSingleDownloader_FailAfterBytes(t *testing.T) {
	...
	tmpDir, cleanup, _ := testutil.TempDir("pulse-failafter-single")
	defer cleanup()
	...
	// Partial file should exist with .pulse suffix
	stats := server.Stats()
...
func TestSingleDownloader_NilState(t *testing.T) {
	...
	tmpDir, cleanup, _ := testutil.TempDir("pulse-nilstate-single")
	defer cleanup()
